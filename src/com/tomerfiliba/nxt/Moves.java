...
public class Moves {
	...
	/*
	 * static class Pause extends DanceMove { public Pause(Robot robot) {
	 * super(robot); }
	 * 
	 * @Override String getCode() { return "BRB"; }
	 * 
	 * @Override void move() { robot.motorR.stop(); robot.motorL.stop(); }
	 * 
	 * @Override public String toString() { return "<PAUSE>"; } }
	 */
